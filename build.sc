...
object zhujiang extends SbtModule with CommonModule {
  ...
  override def millSourcePath = os.pwd / "zhujiang"
  override def moduleDeps = super.moduleDeps ++ Seq(rocketchip, xsutils)
}

object axi2chi extends SbtModule with ScalafmtModule with CommonModule {

  override def millSourcePath = os.pwd

  override def moduleDeps = super.moduleDeps ++ Seq(rocketchip, xsutils, zhujiang)
